...
- [x] 7.3 Add "Auto-assign" button in budget view header
- [x] 7.4 Implement partial assignment

## 8. Inspector Panel

- [x] 8.1 Create inspector endpoint (Go API)
- [x] 8.2 Create inspector panel template (right side panel + bottom sheet)
- [x] 8.3 Implement category selection via JavaScript
- [x] 8.4 Display in inspector: balance, assigned, activity, target, avg
- [x] 8.5 Add quick action buttons (Cover, + Transacción)
- [x] 8.6 Create mobile bottom-sheet version

## 9. Spotlight Mode

- [x] 9.1 Implement Spotlight endpoint (Go API)
- [x] 9.2 Create Spotlight template (collapsible section)
- [x] 9.3 Add badge with count
- [x] 9.4 Hide when no pending items
...
- [x] 10.4 Add color indicators to sidebar account balances
...
- [x] 12.1 Create fixed bottom nav bar with 3 tabs
- [x] 12.2 Add icons for each tab
- [x] 12.3 Implement tab switching (server-side)
- [x] 12.4 Add active tab indicator
- [x] 12.5 Simplify mobile header

## 13. Drag-and-Drop Category Reordering

- [x] 13.1 Integrate SortableJS
...
- [x] 14.3 Create "Cost to be me" widget in budget view header
- [x] 14.4 Implement Reality Check alert
